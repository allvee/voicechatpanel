...
$cn = connectDB();
//$qry="select NickFile from tempdostlist where Mobileno='$mobileno' order by RegDate desc Limit 0,1";
$qry="SELECT profile AS NickFile FROM user WHERE msisdn='$mobileno' AND user_status='1'";
$rs = Sql_exec($cn,$qry);
