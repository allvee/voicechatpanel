<?PHP
   ...
   require_once $COMMONPHP;
	...
	//$qry="update tempdostlist set popularity='$popularity', BusyStatus='$BusyStatus', RegDate='$regdate'  where DostID='$dostid' and Mobileno='$mobile_no'";
        $qry="update user set popularity='$popularity', busy_status='$BusyStatus', registration_date='$regdate'  where voice_chat_id='$dostid' and msisdn='$mobile_no' AND user_status='1'";
	$rs = Sql_exec($cn,$qry);
	if($rs)
	{
